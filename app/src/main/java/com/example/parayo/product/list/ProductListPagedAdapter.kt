...
class ProductListPagedAdapter (private val listener : OnItemClickListener) : PagedListAdapter<ProductListItemResponse,
ProductListPagedAdapter.ProductItemViewHolder>(DIFF_CALLBACK){
    ...
    companion object{
        ...
        val DIFF_CALLBACK =
            ...
            object : DiffUtil.ItemCallback<ProductListItemResponse>(){
                ...
                override fun areItemsTheSame(oldItem: ProductListItemResponse, newItem: ProductListItemResponse
